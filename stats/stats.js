...
function clickedBar(d,i){
	$("#pieChartModal>.modal-content").html("");
	createPieChartFor(d);
...
function createPieChart(){
	...
	// define tooltip
	var tooltip = d3.select('#resources-pie-chart') // select element in the DOM where the modal exists
...
function createPieChartFor(d){
	...
	var svg = d3.select('#pieChartModal>.modal-content') // select element in the DOM where the modal exists
	.append('svg') // append an svg element to the element we've selected
	.attr('width', width) // set the width of the svg element we just added
	.attr('height', height) // set the height of the svg element we just added
	.append('g') // append 'g' element to the svg element
	...
	// define tooltip
	var tooltip = d3.select('#pieChartModal>.modal-content') // select element in the DOM where the modal exists
	.append('div') // append a div element to the element we've selected                                    
	.attr('class', 'tooltip'); // add class 'tooltip' on the divs we just selected
